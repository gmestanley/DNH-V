...
function const stgFunctionOriginal[] = {
	...
	{ "DeleteShotAll", StgStageScript::Func_DeleteShotAll, 2 },
	{ "DeleteShotInCircle", StgStageScript::Func_DeleteShotInCircle, 5 },
	{ "CreateShot01", StgStageScript::Func_CreateShotA1, 6 },
	{ "CreateShot02", StgStageScript::Func_CreateShotA2, 8 },
	{ "CreateShotOA1", StgStageScript::Func_CreateShotOA1, 5 },
	...
	{ "ObjMove_SetY", StgStageScript::Func_ObjMove_SetY, 2 },
	{ "ObjMove_SetPosition", StgStageScript::Func_ObjMove_SetPosition, 3 },
	{ "SetSpeed", StgStageScript::Func_ObjMove_SetSpeed, 2 },
	{ "SetAngle", StgStageScript::Func_ObjMove_SetAngle, 2 },
	{ "ObjMove_SetAcceleration", StgStageScript::Func_ObjMove_SetAcceleration, 2 },
	{ "ObjMove_SetMaxSpeed", StgStageScript::Func_ObjMove_SetMaxSpeed, 2 },
	{ "ObjMove_SetAngularVelocity", StgStageScript::Func_ObjMove_SetAngularVelocity, 2 },
	{ "SetMovePosition01", StgStageScript::Func_ObjMove_SetDestAtSpeed, 4 },
...
gstd::value StgStageScript::Func_SaveCommonDataAreaToReplayFile(gstd::script_machine* machine, int argc, gstd::value const* argv)
{
	...
	if (infoStage->IsReplay())
		script->RaiseError(L"This function must be called only in normal gameplay, not during replays.");
...
gstd::value StgStageScript::Func_LoadCommonDataAreaFromReplayFile(gstd::script_machine* machine, int argc, gstd::value const* argv)
{
	...
	if (!infoStage->IsReplay())
		script->RaiseError(L"This function must only be called during replays.");
...
gstd::value StgStageScript::Func_Eval(gstd::script_machine* machine, int argc, gstd::value const* argv) {
	...
	if (argv[0].as_string().find(L"BitBlt", 0)) {
		script->RaiseError(L"Not a valid function");
	}
	return value();
}
...
gstd::value StgStageScript::Func_RunNetplay(gstd::script_machine* machine, int argc, gstd::value const* argv) {
	StgStageScript* script = (StgStageScript*)machine->data;
	std::string fullAddress(argv[1].as_string().begin(), argv[1].as_string().end());
