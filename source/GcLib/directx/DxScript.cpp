...
function const dxFunctionOriginal[] = {
	...
	//Dx関数：オブジェクト操作(RenderObject)/Dx Functions: Object Operation (RenderObject)
	{ "SetX", DxScript::Func_ObjRender_SetX, 2 },
	{ "SetY", DxScript::Func_ObjRender_SetY, 2 },
	{ "ObjRender_SetZ", DxScript::Func_ObjRender_SetZ, 2 },
	{ "ObjRender_SetPosition", DxScript::Func_ObjRender_SetPosition, 4 },
	{ "ObjRender_SetAngleX", DxScript::Func_ObjRender_SetAngleX, 2 },
	{ "ObjRender_SetAngleY", DxScript::Func_ObjRender_SetAngleY, 2 },
...
DxScript::DxScript()
{
	_AddFunction(dxFunctionPH3, sizeof(dxFunctionPH3) / sizeof(function));
